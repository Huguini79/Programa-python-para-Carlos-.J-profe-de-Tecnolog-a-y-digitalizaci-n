...
def mostrar():
    ...
    label = tk.Label(root2, text=f'{personas}', wraplength=200)
    label.pack()
    root2.mainloop()
...
botónmostr = tk.Button(root, text='Mostrar lista', height='2', width='25', command=mostrar)
...
botónmostr.grid(row=5, column=0, padx=10, pady=10)
root.mainloop()
